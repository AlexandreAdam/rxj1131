...
#info about the lens :
full_lensname ='RX J1131-1231'
lcs_label = ['A','B','C','D']
delay_labels = ['AB', 'AC', 'AD', 'BC', 'BD', 'CD']
#initial guess :
timeshifts = ut.convert_delays2timeshifts([0.,0.,-90.])#give the estimated AB delay
...
### SPLINE PARAMETERS ###
knotstep = [20] #give a list of the parameter you want

### REGDIFF PARAMETERS ###
#To use 5 set of parameters pre-selected :
use_preselected_regdiff = True #highly recommended, set to True
preselection_file = '/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/config/preset_regdiff.txt' #'config/preset_regdiff.txt'
...
# copies -> to obtain mean time-delay measurements
ncopy = 20 #number of copy per pickle
ncopypkls = 25 #number of pickle

# mock -> to obtain uncertainties on mean time-delay measurement
nsim = 20 #number of copy per pickle
nsimpkls = 40 #number of pickle
truetsr = 20.0  # Range of true time delay shifts when drawing the mock curves
...
tweakml_name = 'tweakml' #give a name to your tweakml, change the name if you change the type of tweakml, avoid to have _opt_ in your name !
tweakml_type = 'colored_noise' #choose either colored_noise or PS_from_residuals
shotnoise_type = 'magerrs' #Select among [None, "magerrs", "res", "mcres", "sigma"] You should have None for PS_from_residuals

find_tweak_ml_param = False #To let the program find the parameters for you, if false it will use the lines below :
colored_noise_param = [[-2.0,0.6],[-1.1,0.9],[-0.7,3.2],[0,7.5]] #give your beta and sigma parameter for colored noise, used only if find_tweak_ml == False / uses noise_params of sim10
...
###### MARGINALISE SPLINE AND REGDIFF TOGETHER #######
...
work_dir='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/'
data_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/data/'
pickle_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/pkl/'
simu_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/Simulation/'
config_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/config/'
lens_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/Simulation/rxj1131_quad/'
figure_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/Simulation/rxj1131_quad/figure/'
report_directory='/home/charles/Documents/University/Masters/Classes/PHY6669/Projet/Codes/rxj1131/rxj1131_pipeline/Simulation/rxj1131_quad/report/'
data = pickle_directory + 'rxj1131_quad.pkl' 
