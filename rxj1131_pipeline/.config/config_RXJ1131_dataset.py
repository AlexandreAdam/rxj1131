...
if simoptfctkw == "regdiff":
	...
	sys.exit()
#Automaticaly generated paths : 
work_dir='.'
data_directory='.data/'
pickle_directory='.pkl/'
simu_directory='.Simulation/'
config_directory='.config/'
lens_directory='.Simulation/RXJ1131_dataset/'
figure_directory='.Simulation/RXJ1131_dataset/figure/'
report_directory='.Simulation/RXJ1131_dataset/report/'
data = pickle_directory + 'RXJ1131_dataset.pkl' 
